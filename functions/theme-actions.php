...
<div class="row" id="copyright-note">
	...
	<div class="to-top">Developed by <a href="https://www.facebook.com/V-Team-404502496547851/" rel="nofollow">VTeam</a></div>
</div>
<!--end copyrights-->
<?php }
}
...
if ( ! function_exists( 'mts_archive_post' ) ) {
	...
	function mts_archive_post( $layout = '' ) {
		...
		<a href="<?php echo esc_url( get_the_permalink() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>" rel="nofollow" class="post-image post-image-left">
            ...
            <date class="post_date">
                <span class="post_date_day"><?php $x = get_the_date('d'); echo $x; ?></span>
                <br>
                <span class="post_date_month"><?php $x = get_the_date('M'); echo $x; ?></span>
            </date>
		</a>
		<header>
			<?php if( $mts_options['mts_show_post_info_small'] == '1') { ?>
			...
			<?php } ?> 
			<h2 class="title front-view-title"><a href="<?php echo esc_url( get_the_permalink() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>"><?php echo mb_strtoupper(the_title('','',false)); ?></a></h2>
            ...
            <div class="post_author">
                <img class="img-circle" src="<?php echo get_wp_user_avatar_src(get_the_author_meta('ID'), 96); ?>" width="24px" height="24px">
